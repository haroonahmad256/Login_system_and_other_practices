...
void signin_function(char input_username[], char input_password[])
{
...
int main()
{
    ...
    while (i)
    {
        ...
        case 2:
            ...
            signin_function(enter_username, enter_password);
            printf("Enter any key to continue.....................");
            scanf("%c", &cont);
            if (cont)
            {
